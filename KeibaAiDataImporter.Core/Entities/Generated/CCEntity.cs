...
{
    /// <summary>
    /// JV_CC_INFO — Auto-generated entity
    /// </summary>
    public class CCEntity : JvEntity
    {
        ...
        public string CCInfoAfter_Kyori { get; private set; } = string.Empty;
        public string CCInfoAfter_TruckCd { get; private set; } = string.Empty;
        public string CCInfoBefore_Kyori { get; private set; } = string.Empty;
        public string CCInfoBefore_TruckCd { get; private set; } = string.Empty;
        public string JiyuCd { get; private set; } = string.Empty;
        ...
        public override void SetData(byte[] buffer)
        {
            ...
            CCInfoAfter_Kyori = FixedLengthParser.ReadString(span, 35, 4);
            CCInfoAfter_TruckCd = FixedLengthParser.ReadString(span, 39, 2);
            CCInfoBefore_Kyori = FixedLengthParser.ReadString(span, 41, 4);
            CCInfoBefore_TruckCd = FixedLengthParser.ReadString(span, 45, 2);
            JiyuCd = FixedLengthParser.ReadString(span, 47, 1);
            crlf = FixedLengthParser.ReadString(span, 48, 2);
        }
    }
}
