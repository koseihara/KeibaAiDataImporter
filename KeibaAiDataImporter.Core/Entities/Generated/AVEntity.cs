...
{
    /// <summary>
    /// JV_AV_INFO — Auto-generated entity
    /// </summary>
    public class AVEntity : JvEntity
    {
        ...
        public string JiyuKubun { get; private set; } = string.Empty;
        ...
        public override void SetData(byte[] buffer)
        {
            ...
            JiyuKubun = FixedLengthParser.ReadString(span, 73, 3);
            crlf = FixedLengthParser.ReadString(span, 76, 2);
        }
    }
}
